...
const TermsOfService = () => {
  ...
  return (
    <div dir="rtl"  className="relative bg-gradient-to-b from-purple-500 to-purple-800 min-h-screen text-white rtl">
      {/* כפתור חזרה לדף הבית */}
      <button
      ...
      <div className="container mx-auto py-16 px-6">
        {/* כותרת הדף */}
        <h1 className="text-5xl font-bold text-center mb-12">תנאי שימוש</h1>
        ...
        <div className="bg-white text-gray-800 rounded-lg shadow-lg p-8">
          ...
          <section className="mb-8">
            ...
            <p className="text-lg leading-relaxed">
              תנאי שימוש אלו ("התנאים") מגדירים את הכללים וההנחיות לשימוש
              בפלטפורמה שלנו. על ידי שימוש באתר, אתם מאשרים שקראתם והסכמתם
              לתנאים אלו. אם אינכם מסכימים לתנאים, אנא הימנעו משימוש בשירותים
              שלנו.
            </p>
          </section>
