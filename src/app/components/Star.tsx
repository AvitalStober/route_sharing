...
//   const starsArray =
//     filtered === 2
//       ? Array(5).fill("empty") // תמיד 5 כוכבים ריקים אם filtered === 2
//       : [
//           ...Array(Math.floor(rate)).fill("full"), // כוכבים מלאים
//           ...(rate % 1 >= 0.8 ? ["full"] : rate % 1 >= 0.3 ? ["half"] : []), // כוכב חצי לפי השבר
//           ...Array(5 - Math.ceil(rate)).fill("empty"), // כוכבים ריקים
//         ];

//   return (
//     <div className="flex space-x-1 mt-2">
//       {starsArray.map((type, index) => (
//         <div key={index} className="inline-block hover:cursor-pointer">
//           {type === "full" && (
//             <FontAwesomeIcon
//               icon={faStar}
//               color={"gold"}
//               className="w-6 h-6"
//               onClick={() => filtered === 2 && onClick?.(index + 1)} // קליק רק אם filtered === 2
//             />
//           )}
//           {type === "half" && (
//             <FontAwesomeIcon
